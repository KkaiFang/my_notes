...
<!-- 通用有趣主页 -->
<div class="fk-header-row">
  <!-- 左侧：文字内容 -->
  <div class="fk-header-text">
    <div class="fk-header-title">探索者</div>
    <div class="fk-header-subtitle">
      <span class="fk-header-subtitle-inner">
        知识的收集者
        <svg width="280" height="18" class="fk-header-underline" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="fk-header-motto">记录生活 分享思考</div>
    <div class="fk-header-btns">
      <a href="/my_notes/blog/" class="fk-header-btn">📚 博客</a>
      <a href="/my_notes/msgboard/" class="fk-header-btn">💬 留言</a>
    </div>
  </div>
  <!-- 右侧：头像及光辉 -->
  <div class="fk-header-avatar">
...
[data-md-color-scheme="slate"] .fk-header-btn {
  color: #6ecbff;
  background: rgba(30, 41, 59, 0.8);
  border-color: rgba(110, 203, 255, 0.4);
  box-shadow: 0 2px 8px rgba(106, 203, 255, 0.1);
...
[data-md-color-scheme="slate"] .fk-header-btn:hover {
  background: rgba(110, 203, 255, 0.15);
  color: #ffffff;
  border-color: #6ecbff;
}
...
-   :simple-aboutdotme:{ .lg .middle } __关于__
    ...
    - [留言板](msgboard.md)[^Knowing-that-loving-you-has-no-ending] 
    - [博客](blog/index.md)
    - [:octicons-arrow-right-24: 了解我](about/about.md)[^see-how-much-I-love-you]
    - [支持作者]() 
</div>
